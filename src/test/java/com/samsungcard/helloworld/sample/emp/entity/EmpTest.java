...
class EmpTest {
    ...
    public void tset01() {
        ...
        //expect
        Exception e = Assertions.assertThrows(IllegalArgumentException.class, empBuilder::build);

        assertEquals("이름(은/는) 필수 입력값 입니다.", e.getMessage());
    }
}
